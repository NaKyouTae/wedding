    ...
    const onShareKakao = useCallback(() => {
        if (Kakao) {
            Kakao.Share.sendDefault({
                ...
                content: {
                    title: '나규태 ♡ 최보영 결혼합니다.',
                    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/wedding-9b3cb.appspot.com/o/thumbnail02.png?alt=media&token=c5056b06-105f-4e18-be4c-37ae6753e6c5', // 메인 이미지
